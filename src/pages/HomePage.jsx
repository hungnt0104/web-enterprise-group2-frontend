            ...
            <main>
                <div className="trending-area fix pt-25 gray-bg">
                    <div className="container">
                        <h1 align="center" className="section-tittle mb-30">Articles in this semester</h1>
                                                                    ...
                                                                    {articleList
                                                                        ...
                                                                        .map(article => (
                                                                            <div key={article.id} className="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                                                <div className="whats-right-single mb-20">
                                                                                    <div className="whats-right-img">
                                                                                        <img height='104px' src={`https://web-enterprise-group2-backend-test.onrender.com/images/${article.images[0]}`} alt={article.title} />
                                                                                    </div>
                                                                                    <div className="whats-right-cap">
                                                                                        <h4><a href={article._id}>{article.title}</a></h4>
                                                                                        <p>{article.date}</p>
