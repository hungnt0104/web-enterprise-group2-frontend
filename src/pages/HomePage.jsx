...
const HomePage = () => {
    ...
    <div class="trending-area fix pt-25 gray-bg">
        <div class="container">
            <h1 align="center" class="section-tittle mb-30">{currentEvent.name}</h1>
            <div class="trending-main">
                <div class="row">
                <div className="col-lg-8">
    <div className="slider-active">
    ...
    <div className="col-lg-12">
        <div className="row">
            {topFiveArticles.map(article => (
                <div className="col-lg-3 col-md-6 col-sm-12"> {/* Adjusted column sizes for responsiveness */}
                    <div className="weekly2-single">
                        <div className="weekly2-img">
                            <img 
                                ...
                                src={`https://web-enterprise-group2-backend-test.onrender.com/images/${article.images[0]}`} 
                                alt="" 
                            /> {/* Added inline style using JSX syntax */}
                        </div>
