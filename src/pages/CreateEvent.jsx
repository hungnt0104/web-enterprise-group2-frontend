...
export default function CreateEvent() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('/admin/createEvent', {
        name,
        description,
        startDate,
        firstDeadline
                ...
                <form onSubmit={handleSubmit}>
                  <div className="row">
                    <div className="col-md-12 mb-4">
                      <div className="form-outline">
                        <label className="form-label" htmlFor="firstName">Name</label>
                        <input type="text" id="firstName" className="form-control form-control-lg" onChange={(e) => setName(e.target.value)} required />
                      </div>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-12 mb-4">
                      <div className="form-outline">
                        <label className="form-label" htmlFor="firstName">Description</label>
                        <textarea type="text" id="firstName" className="form-control form-control-lg" onChange={(e) => setDescription(e.target.value)} required />
                      </div>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-12 mb-4 pb-2">
                      <div className="form-outline">
                        <label className="form-label" htmlFor="emailAddress">Start Date</label>
                        <input type="datetime-local" id="datetime" className="form-control form-control-lg" onChange={(e) => setStartDate(e.target.value)} required />
                      </div>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-md-12 mb-4 pb-2">
                      <div className="form-outline">
                        <label className="form-label" htmlFor="emailAddress">First Deadline</label>
                        <input type="datetime-local" id="datetime" className="form-control form-control-lg" onChange={(e) => setFirstDeadline(e.target.value)} required />
                      </div>
                    </div>
                  </div>
                  <div className="mt-4 pt-2">
