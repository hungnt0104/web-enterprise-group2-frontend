                                ...
                                <div className="col-lg-8 posts-list">
                                    <div className="single-post">
                                        ...
                                        <div className="blog_details">
                                            <h2>{event.name}</h2>
                                            <ul className="blog-info-link mt-3 mb-4">
                                                <li><a><i className="fa fa-user"></i> {event.status}</a></li>
                                            </ul>
                                            <img width="100%" src="https://www.greenwichsu.co.uk/pageassets/aboutus/locations/uni.jpg" alt="" />
                                    ...
                                    <div className="blog-author">
                                        <div className="media align-items-center">
                                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQTSRpZvlnKKyXchflZbZfGEeF45sMbBVm2LP2U750H6Q&s" alt="" />
                                            <div className="media-body">
                                                <a><h4>Start Date: {event.startDate}</h4></a><br />
                                                <a><h4>First Deadline: {event.closureDates.firstDeadline}</h4></a><br />
                                                <a><h4>Final Deadline: {event.closureDates.finalClosureDate}</h4></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="comment-form">
