              ...
              <div className="card-body p-4 p-md-5">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="row">
                    <div className="col-md-6 mb-4">
                      <h6 className="mb-2 pb-1">Select the role: </h6>
                      {["Admin", "Student", "Manager", "Coordinator"].map((option) => (
                        <div key={option} className="form-check form-check-inline">
                          <input type="radio" name="Role" value={option} onChange={(e) => setRole(e.target.value)} required/>
                          <label className="form-check-label" htmlFor="femaleGender">{option}</label>
                        </div>
                      ))}
                    </div>
                    {(role === "Student" || role === "Coordinator") && (
